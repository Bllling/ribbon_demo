package com.lin.springcloud.ribbon.server;
...
public class RibbonServerAppliction {
    public static void main( String[] args ){
       SpringApplication.run(RibbonServerAppliction.class, args);
    }
    ...
    public IRule ribbonRule(){
    	return new RoundRobinRule();  // 采用轮询
    }
    
    
    /**
     * spring clound的commons模块提供了一个@LoadBalance注解，方便我们对RestTemplate添加一个LoadBalanceClient以实现客户端负载均衡
     * @return
     */
    @Bean
    @LoadBalanced
